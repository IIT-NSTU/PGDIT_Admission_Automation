...
/* ______________Login ______________ */
...
.content .main-div .submit-button {
    display: flex;
    justify-content: center;
   margin-top: 20px;
}
.content .main-div .submit-button button{
    font-size: 15px;
    border: none;
    width:100px;
    height: 40px;
...
.content .main-div .submit-button button:hover{
    font-size: 17px;
...
/* ___________Log out Section ____________ */
.container1 .logout-form{
    width: 60%;
}
.row h5{
  color: black;
...
<body>
    ...
    <!-- ________________ Director Logout________________ -->
          ...
          <form class="logout-form" action="Logout.php">
              <div class="content">
                  <div class="main-div">
                      ...
                      <div class="row">
                      <h5>Do you want to log out form here ?</h3>
                      </div>
