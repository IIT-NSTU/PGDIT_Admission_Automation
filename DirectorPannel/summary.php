...
<!-- _____________ Summery ____________ -->
...
<section class="setResult-section">
    <div class="container1">
        <form class="setResult-form" action="">
            <div class="content">
                <div class="main-div">
                    <div class="title">
                      Summery
                    ...
                    <div class="row">
                        <table>
                         <tr>
                            ...
                            <td><?php echo $num_result; ?></td>
                         </tr>
                            <tr>
                                <th>Total Application fee</th>
                                <td><?php echo ($num_result*1000); ?></td>
                            </tr>
                            <tr>
                                <th>Total Admitted</th>
                                <td><?php echo $admitted_result; ?></td>
                            </tr>
                            <tr>
                                <th>Available Seat</th>
                                <td><?php echo (23-$admitted_result); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
